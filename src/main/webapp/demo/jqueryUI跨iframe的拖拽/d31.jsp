...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-6" style="height: 100%">
            ...
            <span>MMMMMMMMM</span>
            <div style="border: 1px solid red;width: 200px;height: 200px;float: left" class="picdiv" id = "mm">iframe-1</div>
        <%-- <div id="trees">
