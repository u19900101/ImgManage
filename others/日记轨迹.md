...
![](img\image-20210825171252438.png)输出**两次**数量,解决bug
...
![image-20210826000355552](img\image-20210826000355552.png)

[源文件](echart\python\csv绘图\d copy.html)
...
![image-20210826234116797](img\image-20210826234116797.png)

### 4.3 早上6点的都算是前一天写的日记 因为发现有一天是4点写的

### 4.4 优化去重  去掉2/12   将第一个2/13 改为2/13

![image-20210827222102351](img\image-20210827222102351.png)
...
![image-20210829185443745](img\image-20210829185443745.png)

换用**高德**api，不用转换 显示的经度更高

![image-20210829214010849](img\image-20210829214010849.png)
...
![image-20210830111554529](img\image-20210830111554529.png)

5.~~热力图点有显示功能~~   只有蜂窝可以显示 

5.在地图上显示日记信息

![image-20210902212948615](img\image-20210902212948615.png)

![image-20210830172606701](img\image-20210830172606701.png)
...
![image-20210901164734796](img\image-20210901164734796.png)
...
![image-20210902212736449](img\image-20210902212736449.png)

#### 2.添加高德地图、谷歌地图

#### 3.地图中心随时间轴移动

<video src="./img/WeChat_20210903081142.mp4"   autoplay="autoplay" controls="controls" preload="auto" width = 1000>  </video>

4.在主页中引入 气泡图和时间线 链接

![image-20210903082515378](img\image-20210903082515378.png)



# 2.查看日记

## 1.将经纬度修改为 地名--市+区+门牌号，调整为竖直日历

![image-20210903105816102](D:\MyJava\mylifeImg\others\img\image-20210903105816102.png)

点击日期和直接在右侧显示对应日记，类似这种效果

![image-20210903111058135](D:\MyJava\mylifeImg\others\img\image-20210903111058135.png)

## 2.将导出的html 转化为 markdown
...
经过对比  editor.md 和  vditor 、StackEdit，最后综合性能，选择了 **editor.md**，但对比typora,仍然有差距：

- 1.没有大纲视图
- 2.不能直接对视频进行预览
- ~~3.不能 预览和 编辑同时进行，编辑时不能隐藏 源文件编辑框~~（有这个功能）

### 3.1.将 本地的 md 文件可以读入到 网页中

将所有日记转化为单个的md文件

去除 标题中的中文 空格

解决了 文件名称问题，html的名称只是截取的部分长度，需要进行重新命名，以便页面跳转时可以找到

![image-20210905235910302](D:\MyJava\mylifeImg\others\img\image-20210905235910302.png)
